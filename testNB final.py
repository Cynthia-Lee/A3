...
clf = MultinomialNB(alpha=0.001)
text_clf = check_performance(vect, clf)
# vect = TfidfVectorizer(lowercase=True, max_df=0.5, ngram_range=(1,2), tokenizer=tokenize_and_lemma)
# clf = MultinomialNB(alpha=0.001)
# text_clf = check_performance(vect, clf)
# parameters = {
#     'vect__ngram_range': [(1, 1), (1, 2), (2, 2), (1, 3), (3, 3), (1, 4), (4, 4)],
...
vect = CountVectorizer(lowercase=True, max_df=0.5, ngram_range=(1,3), tokenizer=tokenize_and_lemma)
clf = MultinomialNB()
select = SelectPercentile(percentile=60)
text_clf = check_performance(vect, clf)
text_clf = check_performance(vect, clf, select)